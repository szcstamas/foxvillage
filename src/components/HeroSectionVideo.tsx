...
const HeroSection = ({ h1TextFirstSlice, h1Span, h1TextSecondSlice, pText, primaryBtnText, primaryBtnLink, primaryBtnIcon, secondaryBtnText, secondaryBtnLink, secondaryBtnIcon, videoBackground }: Props) => {
    return (
